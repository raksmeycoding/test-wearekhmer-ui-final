...
const Card = () => {
  ...
  const AUTHOR_ICON = (
    <span className="">
      <img
        className="w-8 h-8 object-cover rounded-full border border-[#FEB55E]"
  ...
  // <div ref={cardRef} className={`card ${shouldFadeUp ? "fade-up" : ""}`}>
  return (
    <div
      className="bg-[#F6F6F4] px-6 py-6 rounded-3xl"
      data-aos="fade-up"
      data-aos-duration="1500"
    >
      <img
        className="h-[250px] max-w-[350px] object-cover rounded-3xl "
      ...
      />
      {/* category name */}
      <div className="text-[#868688] mt-2">Category Name</div>

      {/* title card */}
      <h3 className="line-clamp-1 text-[#545050] mt-2 font-bold">
        The Impact of the Khmer Rouge - Learn More About Cambodia
      </h3>

      {/* description */}
      <div className="description line-clamp-1 text-[#868688] mt-2">
      ...
      {/* time date */}
      <div className="text-[#868688] mt-2">2 hours ago</div>

      {/* btn */}
      <div className="btnGroup flex flex-row  justify-between items-center">
